  ...
  >
    ...
    <div class="h-16 flex items-center justify-between px-4 border-b"
      ...
      <router-link to="/" class="flex items-center gap-3">
        ...
        <span v-if="!collapsed" class="font-semibold text-lg" :class="settingsStore.darkMode ? 'text-dark-text' : 'text-light-text'">
          MyDevStack
        </span>
      </router-link>
      <button
    ...
    <div v-if="!collapsed" class="mt-4 px-2">
      ...
      <div class="space-y-0.5 max-h-[calc(100vh-300px)] overflow-y-auto">
        ...
        >
          <span class="w-2 h-2 rounded-full flex-shrink-0" :class="'bg-' + service.color"></span>
